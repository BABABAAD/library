				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="navbar-nav ml-md-auto">
							...
							<li class="nav-item dropdown"><a class="nav-link fa fa-window-close" href="exit.jsp" id="navbarDropdownMenuLink" >
								</a>
								</li>
						</ul>
					</div>
			...
			<table class="table table-hover table-sm">
				...
				<tbody>
					...
					<td><%=book.getCbDate()%></td>
						...
						<td><a href="#modal-container-645581 "data-toggle="modal" onclick="window.did='<%=book.getId()%>'" class="fa fa-trash fa-2x" title="删除"></a>
...
<div class="modal fade" id="modal-container-645581" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<script type="text/javascript">
		...
		function fillSmallSel(typs) {
			document.getElementById("inputsid").innerHTML='<option value="-1">--请选择小类--</option>';
			for (var i = 0; i < typs.length; i++) {
				var op = new Option(typs[i].name, typs[i].id);
